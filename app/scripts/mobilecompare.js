angular.module('anantbajaj')
  .controller('mobilecomparectrl',function ($scope, $http,$rootScope,$window,$timeout,$location,onlineStatus,$localStorage,$http,$rootScope) {
    ...
    var api_url="https://anant-bajaj-dev.myridz.com";
		$scope.modalCarShown = false;
	 	$scope.priceModal = false;
            ...
            $scope.commonfeature=function(data){
                $scope.changecolor="";
                if(data==true){
             ...
             $scope.uncommonfeature=function(data){
              $scope.changecolor='';
            }
